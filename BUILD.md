...
cmake -S . -B build -DCMAKE_BUILD_TYPE=release -DCMAKE_TOOLCHAIN_FILE=x86_64-w64-mingw32.cmake -DENABLE_XAUDIO=OFF -DCEMU_CXX_FLAGS="-msse4.1;-maes;-mavx2" -G Ninja -DCMAKE_MAKE_PROGRAM=/usr/bin/ninja
cmake --build build
